...
public class GameBoard extends JPanel implements ActionListener {
    ...
    private void loadImages(){
        ImageIcon image_apple = new ImageIcon("src/resources/apple.jpg");
        apple = image_apple.getImage();

        ImageIcon image_head = new ImageIcon("src/resources/head.jpg");
        head = image_head.getImage();

        ImageIcon image_body = new ImageIcon("src/resources/dot.jpg");
